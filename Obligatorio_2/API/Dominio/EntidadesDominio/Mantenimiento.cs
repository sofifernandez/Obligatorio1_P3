...
namespace Dominio.EntidadesDominio
{
    public class Mantenimiento:IValidable
    {
        ...
        public void Validar()
        {
            ...
            {
                throw new AltaMantenimientoException("La fecha ingresada debe ser posterior a hoy");
            }

            if (CostoMant < 0) 
            {
                throw new AltaMantenimientoException("Ingrese valores mayores a 0"); //Tuvimos un conflicto con el uso del repositorio de Git y no nos permitió hacer nuevas migraciones para agregar el Range
            }
        }
    }
}
